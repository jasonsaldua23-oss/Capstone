          ...
          <div className="mt-3 space-y-2.5">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                const blankQuantityAt = replacementLines.findIndex((l) => l.productId && !(Number(l.quantity) > 0))
                if (blankQuantityAt >= 0) {
                  setReplacementError(`Enter a quantity for Product #${blankQuantityAt + 1}`)
                  return
                }
