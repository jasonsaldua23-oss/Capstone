          ...
          >
            ...
            {activeTab === "history" ? (
              <View style={styles.historyScreen}>
                ...
                {historyTripId ? (
                  <Pressable style={{ flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 4, paddingBottom: 10 }} onPress={() => { if (historyPointId) setHistoryPointId(null); else setHistoryTripId(null); }}>
                    <Ionicons name="arrow-back" size={16} color="#64748b" />
                    <Text style={{ color: "#64748b", fontSize: 14, fontFamily: "Poppins_600SemiBold" }}>Back</Text>
                  </Pressable>
                ) : null}
