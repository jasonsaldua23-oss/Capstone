...
urlpatterns = [
    ...
    path("auth/password-reset/verify-otp", v.auth_password_reset_verify_otp),
    ...
    path("inventory/empty-returns", v.record_returned_empty_containers),
    ...
    path("push-subscriptions", v.push_subscriptions_collection),
    path("retail/products", v.retail_products),
    path("retail/quote", v.retail_quote),
    path("retail/sales", v.retail_sales_collection),
    path("retail/sales/<str:sale_id>", v.retail_sale_detail),
    path("retail/sales/<str:sale_id>/payment", v.retail_sale_payment),
    path("retail/sales/<str:sale_id>/pickup-status", v.retail_sale_pickup_status),
    path("retail/sales/<str:sale_id>/cancel", v.retail_sale_cancel),
    ...
    path("bottle-returns", v.bottle_returns_collection),
