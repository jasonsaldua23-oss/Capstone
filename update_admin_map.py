...
def update_file(file_path):
    ...
    start_str = "  const mapData = useMemo(() => {"
    end_str = "  }, [ordersForMap, trackingDate, trips])"
    ...
    new_block = """  const mapData = useMemo(() => {
...
if __name__ == "__main__":
    update_file("c:/CAPSTONE/src/components/portals/AdminPortal.tsx")
