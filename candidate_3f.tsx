...
export function TripDetailView({
  ...
  }, [navigationRouteWaypoints, navigationWaypointsKey])
      ...
      <div className="relative min-h-0 flex-1 overflow-y-auto">
        ...
        <div className={isMobileViewport ? 'space-y-0 p-0' : 'space-y-4 p-4'}>
          ...
          <div className="relative overflow-hidden md:hidden">
            <div className="relative flex h-[calc(100dvh-12rem)] min-h-[540px] w-full flex-col overflow-hidden bg-[#f8fbfe]">
            {/* Top Navigation & Status Bar */}
            <div className="relative z-[1000] flex shrink-0 flex-col gap-2.5 bg-white/95 px-4 pb-3 pt-4 shadow-[0_4px_20px_rgba(15,23,42,0.08)] backdrop-blur">
            ...
            {/* Map Area */}
            <div className="relative flex-1 w-full bg-[#dff0ea] overflow-hidden">
              {mapLocations.length === 0 ? (
            ...
            <button
              ...
              className={`absolute bottom-[calc(env(safe-area-inset-bottom)+6.1rem)] right-4 z-40 flex h-10 w-10 items-center justify-center rounded-full border shadow-[0_8px_18px_rgba(15,23,42,0.12)] backdrop-blur transition-all ${voiceGuidanceEnabled ? 'bg-emerald-600 border-emerald-700 text-white' : 'bg-white/92 border-white/80 text-slate-900'}`}
            >
